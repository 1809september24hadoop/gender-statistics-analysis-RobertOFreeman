...
import com.revature.bountyhunt.BountyHuntReducer;
	...
	public class Testinatore {
	  ...
	  public void testMapper() {
		     ...
		     */
	    mapDriver.withInput(new LongWritable(0), new Text(input2S));

	    /*
	     * The expected output is "specified string and 0.
	     */
	    mapDriver.withOutput(new Text(input2S), new IntWritable(0));
	    /*
	     * Run the test.
	     */
	    mapDriver.runTest();
	  ...
	  public void testReducer() {
	     ...
	     */
	    reduceDriver.withOutput(new Text("Afghanistan,male bias,difference,"), new DoubleWritable(7.0));
	  ...
	  public void testMapReduce() {
	    ...
	    /*
	     * For this test, the mapper's input will be 2 specified Strings" 
	     */
